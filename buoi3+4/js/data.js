...
function createCard(name, price, img_link) {
    ...
    img.src = img_link;
    img.alt = name;
    card.appendChild(edit_btn) // add card
...
localStorage.setItem(JSON.stringify(products.data)).addEventListener("input", () => {
